...
//Answer2
	...
	if($tonnage == "6.0") {
		$tonnage = "(6 tons) [ 3 ton + 3 ton]";
	}
	if($tonnage == "7.0") {
		$tonnage = "(7 tons) [ 3 ton + 4 ton]";
	}
	if($tonnage == "8.0") {
		$tonnage = "(8 tons) [ 4 ton + 4 ton]";
	}
	if($tonnage == "9.0") {
		$tonnage = "(9 tons) [ 4 ton + 5 ton]";
	}
	if($tonnage == "10.0") {
		$tonnage = "(10 tons) [ 5 ton + 5 ton]";
	}
	...
	if($answer_filter['equipment_type'] == 'AC') {
		...
		if($answer_filter['conditioner_type'] == 'packaged') {
            ...
            if(get_field($zone_type, $area_id) >5) {
                ...
                $ac_seer_tonnage  = $tonnage.', '.$seer_afue. 'SEER Packaged Air Conditioner'; 
            
            } else {
                
                $ac_seer_tonnage  = $tonnage.' ton, '.$seer_afue. 'SEER Packaged Air Conditioner'; 
            ...
            if(get_field($zone_type, $area_id) >5) {
                ...
                $ac_seer_tonnage = $tonnage.','. $seer_afue. 'SEER Air Conditioner'; 
    ...
    if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow' )) {
       ...
       // echo "Package AC SPLIT". $answer_filter['package_split_ac_model'];
        //exit();
        ...
        if (strpos($tons_temp, 'ton') == false) {
            $tons_temp = $tons_temp.' ton';
        }
        
        
                
        $ac_seer_tonnage = $tons_temp.', '.$seer.' SEER  '.' Air Conditioner';
       ...
       $furnace_model_id = $furnace_seer_tonnage_model[0]->ID;
        ...
        if($answer_filter['packaged_model']!= "") {
            ...
            $ac_seer_tonnage =  str_replace('AC Size : ','',$ac_seer_tonnage_details[1]).', '.$seer.' SEER  '.' Air Conditioner';
            $furnace_seer_tonnage_details = explode("-",$answer_filter['package_split_furnace_model']);
                    $furnace_seer_tonnage_model =  get_posts(array('name'=>sanitize_title($furnace_seer_tonnage_details[0]),'post_type' => 'funrnace'));
                  ...
                  $zone_type = get_post_meta(trim($model_details[$i]), 'zone_type', true);
                    ...
                    if(in_array($zone_type,$ac_zone_det)) {
                        ...
                        if($defalut_model_chosen == 'Not Requested'){
                            ...
                            $defalut_model_chosen =  get_post_meta(trim($model_details[$i]), 'model', true).' '.get_post_field('post_content',trim($model_details[$i]));
                        ...
                        $ac_seer_tonnage = $tonnage.' '.get_post_meta(trim($model_details[$i]), 'seer_afue', true).' SEER Air Conditioner';
                        ...
                        $furnace_seer_tonnage = ' BTU, '.$furnace_seer_tonnage.' AFUE Furnace';
                        ...
                        $furnace_seer_tonnage = get_post_meta(trim($model_details[$i]), 'size', true);
                         ...
                         if($seer == '3 + 4'){
                            ...
                            $ac_seer_tonnage = '(7 tons) 3 ton + 4 ton 14 SEER Air Conditioner';
                        
                        } else if($seer == '4 + 4'){
                            
                            $ac_seer_tonnage = '(8 tons) 4 ton + 4 ton 14 SEER Air Conditioner';
                        
                        } else if($seer == '4 + 5'){
                            
                            $ac_seer_tonnage = '(9 tons) 4 ton + 5 ton 14 SEER Air Conditioner';
                        
                        } else if($seer == '5 + 5'){
                            
                            $ac_seer_tonnage = '(10 tons) 5 ton + 5 ton 14 SEER Air Conditioner';
                        
                        } else if(in_array($seer,array(2.5,3,3.5,4,5))) {
                             $ac_seer_tonnage = $seer.' ton 14 SEER  '.' Air Conditioner';
...
<p class="indent">Based on the information you have provided, it is our estimate that your project should take around <span class="red">'.$number_of_days.' </span>for your project to be completed.  This information will be important later, as it will help us calculate the estimated labor costs for your installation.</p>
<hr/>
...
<p class="indent">Based on the information that you provided, we estimate that a heating and air conditioning system that is of the following size and efficiency rating would work best for your project:</p>';
    ...
    if($ac_seer_tonnage != 'Not requested') {
        $html = $html.'	<p>Air Conditioner (size in tonnage and recommended SEER rating): <span class="red">'.$ac_seer_tonnage.'</span></p>';
    }
    
    if($furnace_seer_tonnage != 'Not requested') { 
        $html = $html.'	<p>Furnace (minimum BTU and recommended AFUE rating): <span class="red">'.$furnace_seer_tonnage.'</span></p>';
    }
    
    //for removein extra price from  Title 
...
<ul>
	<li>Although the reason why this is so will be discussed in more detail later, it is important to properly size your air conditioner or furnace, both for energy usage and proper cooling and heating.  </li>
<li>Based on the answers you provided, as well as our experience and observations, if an air conditioner is installed, it may not be worth the additional money to purchase an air conditioner higher than a value of 16 SEER in your area.  Purchasing a high-SEER unit may not provide an adequate return on your investment in the long-term.</li>
<li>Any furnace recommendations are based on a gas furnace.  <b>Tip:</b> If natural gas is not available in your area, you can have your HVAC contractor install a “propane conversion kit” to modify a gas furnace for use with propane.  This kit typically costs around $45 - $55, and takes just minutes to install.  It will include a new expansion valve that is made for use with the propane molecule.</li>
    ...
    if($answer_filter['customer_interest'] == 'Yes') {
        ...
        if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow') ) {
            ...
            if($ac_seer_tonnage != 'Not requested' && $model_chosen != 'Not requested' ) {
                 ...
                 $html = $html.' <span class="red">'.$model_chosen.'  '.$ac_seer_tonnage.'</span>   <span class="alignright red"> $'.number_format($model_price,2).'</span><br>';
            ...
            if($ac_seer_tonnage != 'Not requested' && $furnace_seer_tonnage != 'Not requested' ) {
                ...
                $html = $html.'	<span class="red">'.ucfirst($furnace_model_chosen).'  '.$furnace_seer_tonnage.'</span>   <span class="alignright red"> $'.number_format($furnace_model_price,2).'</span>';
            ...
            if($model_price!= "") {
                ...
                $html = $html.'	<span class="red">'.ucfirst($model_chosen).'</span><span class="alignright red"> '.number_format($model_price,2).'</span><br>';
            } else {
                $html = $html.'	<span class="red">'.ucfirst($model_chosen).'</span>';
            }
        ...
        if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow') ) {
            ...
            $html = $html.'	<span class="red">'.ucfirst($defalut_model_chosen).'  '.$ac_seer_tonnage.'</span>   <span class="alignright red"> $'.number_format($defalut_model_price,2).'</span><br>';
                
            }
            
            if( $defalut_furnace_model_chosen != 'Not requested' ) {
                
                $html = $html.'	<span class="red">'.ucfirst($defalut_furnace_model_chosen).'</span>   <span class="alignright red"> $'.number_format($defalut_furnace_model_price,2).'</span>';
            ...
            if($defalut_model_chosen != 'Not Requested' or $defalut_model_price != 0) {
                ...
                if($model_price!= "") {
                    //$answer_filter['default_model']
                    $html = $html.'	<span class="red">'.ucfirst($defalut_model_chosen).'</span>      <span class="alignright red">$'.number_format($defalut_model_price,2).'</span><br>';
                } else {
                    $html = $html.'<span class="red">'.ucfirst($defalut_model_chosen).'</span>';
                }
                ...
                if( $defalut_furnace_model_chosen != 'Not requested' ) {
                    ...
                    $html = $html.'<span class="red"> '.ufirst($defalut_furnace_model_chosen).'  '.$furnace_seer_tonnage.'</span>   <span class="alignright red"> $'.number_format($furnace_model_price,2).'</span>';
                }
            }
        }
...
<p>Based on our experience, as well as the information you have provided, we would recommend the following equipment for your project:</p>';   
    if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow') ) {
            
        if($ac_seer_tonnage != 'Not requested' && $defalut_model_chosen != 'Not requested' ) {
            
             $html = $html.'<span class="red"> '.ucfirst($defalut_model_chosen).'  '.$ac_seer_tonnage.'</span><span class="alignright red"> $'.number_format($model_price,2).'</span><br>';
        ...
        //have to add $answer_filter['customer_interest'] == 'No'
        ...
        //exit();
            ...
            if(in_array($zone_type,$ac_zone_det)) {
                ...
                $ac_seer_tonnage = get_post_meta(trim($model_details[$i]), 'seer_afue', true).' SEER Air Conditioner';
    ...
    if($show_defalut_model_chosen != 'Not Requested') {
        ...
        $html = $html.'	<span class="red">'.$show_defalut_model_chosen.'  '.$ac_seer_tonnage.'</span>   <span class="alignright red"> $'.$show_defalut_model_price.'</span><br>';

    }

    if($show_defalut_furnace_model_chosen != 'Not Requested') {
             $html = $html.'	<span class="red">'.$show_defalut_furnace_model_chosen.'</span>   <span class="alignright red"> $'.$show_defalut_furnace_model_price.'</span>';
...
if($answer_filter['customer_interest'] == 'Yes') {
        ...
        if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow') ) {
            ...
            $html = $html.'	<span class="red">'.ucfirst($model_chosen).'  '.$ac_seer_tonnage.' $'.number_format($model_price,2).'</span><br/>';
            
            $html = $html.'	<span  class="red">'.ucfirst($furnace_model_chosen).'  '.$furnace_seer_tonnage.'         $'.number_format($furnace_model_price,2).'</span>';
            ...
            if($model_price!= "") {
                //$answer_filter['default_model']
                $html = $html.'	<span  class="red">'.ucfirst($model_chosen).' '.number_format($model_price,2).'</span>';
            } else {
                $html = $html.'	<span  class="red">'.ucfirst($model_chosen).'</span>';
            }
...
/* ################# */
    ...
    if($answer_filter['equipment_type'] == 'Both' && ($answer_filter['conditioner_type'] == 'split' || $answer_filter['conditioner_type'] == 'dontknow') ) {
        ...
        if($ac_seer_tonnage != 'Not requested' && $defalut_model_chosen != 'Not requested' ) {
             ...
             $html = $html.'<span class="red"> '.ucfirst($defalut_model_chosen).'  '.$ac_seer_tonnage.'</span><span class="alignright red"> $'.$model_price.'</span><br>';
...
<div>Estimated price of labor for your project:</div><br>
